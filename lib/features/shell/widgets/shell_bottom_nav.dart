...
class ShellBottomNav extends StatefulWidget {
  ...
  @override
  State<ShellBottomNav> createState() => _ShellBottomNavState();
}

class _ShellBottomNavState extends State<ShellBottomNav>
  ...
  @override
  void didUpdateWidget(covariant ShellBottomNav oldWidget) {
  ...
  void _springTo(int toIndex) {
    ...
    final simulation = SpringSimulation(
      const SpringDescription(mass: 1, stiffness: 700, damping: 38),
      from,
      clampedTo,
      0,
    );
          ...
          child: BackdropFilter(
            ...
            child: LayoutBuilder(
              builder: (context, constraints) {
                ...
                const bubbleW = 46.0;
                const bubbleH = ShellBottomNav.barHeight - 14;
                const bubbleTop = 6.0;
                const bubbleRadius = VehicleUi.radiusMd;

                final floatT = _breath.value;
                final floatDy = (1.0 - 2.0 * floatT) * 1.2;

                return Container(
                  height: ShellBottomNav.barHeight,
